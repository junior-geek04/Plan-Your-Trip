...
if(isset($_POST['q3_email'])){
    ...
    $q51_otherSpecifications=$_POST['q51_otherSpecifications'];
    
    $sql="INSERT INTO `fldatabase` ( `date`, `pi_fname`, `pi_lname`, `pi_email`, `pi_phone`, `pi_addr_line1`, `pi_addr_line2`, 
    ...
    `no_of_packets`, `required_veh`, `weight_inkg`, `other`) 
    ...
    '$q29_requiredVehicle', '$q36_weightinKg', '$q51_otherSpecifications');";
...
<title>Fullorder form-AMT</title>
...
<form class="jotform-form" action="fl.php" method="post" name="form_201004008705438" id="201004008705438" accept-charset="utf-8" autocomplete="on">
...
value=""  aria-labelledby="label_5" required="">
	  ...
	  <li class="form-line" data-type="control_textarea" id="id_51">
        <label class="form-label form-label-left form-label-auto" id="label_51" for="input_51"> Other Specifications </label>
        <div id="cid_51" class="form-input">
          <textarea id="input_51" class="form-textarea" name="q51_otherSpecifications" cols="40" rows="6" data-component="textarea" aria-labelledby="label_51"></textarea>
        </div>
      </li>
